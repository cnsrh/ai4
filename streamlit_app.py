...
# 모델 로드
# ======================
FILE_ID = st.secrets.get("GDRIVE_FILE_ID", "1yx6lR3xY9nA4rIim68h3H_cfnvXNZGF_")
...
CONTENT_BY_LABEL: dict[str, dict[str, list[str]]] = {
    ...
    labels[1] : {"texts" : ["찌장면은 맛있어"], "images" : ["https://i.namu.wiki/i/j2AxLP9AtrcJebh4DVfGxowfXwI3a95dG_YZb_Ktczc6Ca7ACyd_NJL3YHQMw8SABGTQiJDwSpySOSSBLZVEZw.webp"]},
